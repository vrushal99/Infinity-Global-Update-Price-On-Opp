 ...
 */
define(["N/task", "N/ui/serverWidget"], function (task, ui) {
  ...
  function aftersubmit(context) {
    try {
      ...
      if (
        usdPrice1 != objCurrencyAmount1.usd ||
        britishPrice1 != objCurrencyAmount1.british ||
        canadaPrice1 != objCurrencyAmount1.canada ||
        chinaPrice1 != objCurrencyAmount1.china ||
        euroPrice1 != objCurrencyAmount1.euro ||
        hongPrice1 != objCurrencyAmount1.hong ||
        indiaPrice1 != objCurrencyAmount1.india ||
        japanPrice1 != objCurrencyAmount1.japan ||
        koreanPrice1 != objCurrencyAmount1.korean ||
        singaporePrice1 != objCurrencyAmount1.singapore ||
        swisPrice1 != objCurrencyAmount1.swis
      ) {
